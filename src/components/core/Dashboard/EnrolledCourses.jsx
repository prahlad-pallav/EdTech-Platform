...
export default function EnrolledCourses() {
  ...
  return (
    <>
      <div className="text-3xl text-richblue-800">Enrolled Courses</div>
      {!enrolledCourses ? (
        ...
        <div className="my-8 text-richblack-5">
          {/* Headings */}
          <div className="flex rounded-t-lg bg-richblue-500 ">
          ...
          {enrolledCourses.map((course, i, arr) => (
            <div
              className={`flex items-center border border-richblue-700 ${
            ...
            >
              ...
              >
                ...
                <div className="flex max-w-xs flex-col gap-2">
                  ...
                  <p className="text-xs text-richblue-300">
